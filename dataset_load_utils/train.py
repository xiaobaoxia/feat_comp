...
def main(args):
    ...
    dataset = DataLoader(args.pascal_path, 'train', transform=train_transform)
    num_classes = 21
    dataset_test = DataLoader(args.pascal_path, 'val', transform=val_transform)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_one_epoch(model, optimizer, data_loader,epoch, args.print_freq)
        lr_scheduler.step()
        if args.output_dir:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--pascal_path', type=str, default='../../../VOCdevkit/VOC2012',
                        help='Path to Pascal VOC 2012 folder')
    parser.add_argument('--num-classes', default=21, help='number of classes in dataset')
